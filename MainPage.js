...
const MainPage = () => {
  ...
  // Function to handle navigation to SpeechToText screen
  const navigateToSpeechToText = () => {
    navigation.navigate('SpeechToText'); // Ensure this screen is defined in your navigation stack
  };
    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <View style={styles.featuresSection}>
          ...
          <TouchableOpacity
            style={[styles.featureButton, { backgroundColor: '#FFC1C1' }]}
            onPress={navigateToSpeechToText} // Navigate to SpeechToText screen
          >
